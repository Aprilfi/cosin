...
1、mvn install:install-file -Dfile=C:\Users\qingtian\lib\sdk.jar -DgroupId=com.chatopera.bot -DartifactId=sdk -Dversion=1.0.2 -Dpackaging=jar

2、mvn install:install-file -Dfile=C:\Users\qingtian\lib\mondrian-3.7.0.jar -DgroupId=mondrian -DartifactId=mondrian -Dversion=3.7.0 -Dpackaging=jar
